...
const CityExplorer = () => {
  const cities = [
    { id: 1, href: '#', imgSrc: city1, altText: 'Delhi/NCR', cityName: 'Delhi / NCR', productCount: '3500+' },
    { id: 2, href: '#', imgSrc: city2, altText: 'Mumbai', cityName: 'Mumbai', productCount: '2500+' },
    { id: 2, href: '#', imgSrc: city1, altText: 'Mumbai', cityName: 'Mumbai', productCount: '2500+' },
    { id: 2, href: '#', imgSrc: city2, altText: 'Mumbai', cityName: 'Mumbai', productCount: '2500+' },
    { id: 2, href: '#', imgSrc: city1, altText: 'Mumbai', cityName: 'Mumbai', productCount: '2500+' },
