...
const Testimonials = () => {
  ...
  const prevSlide = () => {
    setCurrentSlide((prev) => (prev - 3 + testimonials.length) % testimonials.length); // Loop to the previous 3 testimonials
  };
    ...
    <div className="mt-4">
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <p className="text-red-600 text-sm font-semibold mb-2">OVER 1.5 LAC HAPPY CUSTOMERS</p>
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Real Stories from Satisfied Customers</h2>
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-600 text-sm mb-6">{testimonial.role}</p>
