...
const handleSkipVideo = () => {
	...
	return (
		<>
			<header
				className={`flex fixed top-0 left-0 w-full z-50 bg-white items-center justify-between px-6 md:px-10 lg:px-20 py-3 gap-4 transition-all duration-300 ${isScrolled ? 'shadow-sm border-b' : ''
					}`}
			>
