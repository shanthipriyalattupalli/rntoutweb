            ...
            <div className="seller-profile-container">
                ...
                <div className="seller-profile-header">
                    <div className="seller-company-info">
                        <h1>
                            RntOut Enterprise <span className="seller-verified">&#x2714;</span>
                        </h1>
                        <p>
                            <span className="seller-contact-item">📞 +91 12345 67890</span> |{" "}
                            <span className="seller-contact-item">✉️ rntout.enterprise@gmail.com</span> |{" "}
                            <span className="seller-contact-item">
                                📍 3-6-288/3, Sri Siva Rama Towers, King Koti, Hyderabad, Telangana, India
                                500029
                            </span>
                        </p>
                    </div>
                ...
                <div className="seller-about-us">
                    <h2>About Us</h2>
                    <p>
                        Fantaslook focusing on garment production and sales, vigorously develop cross-border e-commerce platform to sell clothing, the company mainly sells all kinds of women's clothing, the annual sales are on the rise, the variety of clothing is more and more, women's shirts, tops, dresses, miniskirts, home wear, sportswear, etc. Fantaslook was founded in.{" "}
                        <a href="#" className="seller-read-more">read more...</a>
                    </p>
                    <p className="seller-business-name">
                        <strong>Business Name:</strong> Yueyang Guangzhou Import and Export Co Ltd
                    </p>
                </div>
                ...
                <div className="seller-store-reviews">
                    <p>
                        ...
                        <span className="seller-review-stats">(19,997 ratings and 1,273 reviews)</span>
                    </p>
                </div>
