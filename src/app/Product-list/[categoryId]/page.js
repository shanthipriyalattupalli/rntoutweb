...
//       try {
//         setLoading(true);
//         const newData = await fetchProducts(page, 2);
...
export const metadata = {
  title: "Your Ultimate Destination for Quality Rental Products | RNT Out",
  description: "Discover quality rental products at RNT Out for all your adventures. From outdoor gear to essentials, we have everything you need to elevate your experience. Rent today!",
};
