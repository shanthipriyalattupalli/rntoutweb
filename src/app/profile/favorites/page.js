            ...
            {products.map((product, index) => (
                <div key={index} className="product-card">
                    <div className="product-image-container">
                        <img src={product.image} alt={product.title} className="product-image" layout="fill" objectFit="cover" /> {/* Use Image component */}
                        <div className="badge-icon">
                            <img src="/Assets/bookmark.png" alt="Bookmark Icon" className='book' layout="fixed" width={20} height={20} />
                        </div>
                    </div>
                    <div className="product-details">
                        <h3 className="product-title">{product.title}</h3>
                        <p className="product-price">{product.price} <span className='pro-span'>/day</span></p>
                        <div className='pro-date'>
                            <img src="/Assets/hp33.png" alt="Calendar Icon" className='vector1'  />
                            <p className="product-dates m-0">{product.dates}</p>
                        </div>
                        <div className='pro-stock'>
                            <img src="/Assets/hp34.png" alt="Stock Icon" className='vector1'  />
                            <p className='product-stock m-0'>
                                {product.stock} stock available
                            </p>
                        </div>
                        <div className='pro-last'>
                            <img src="/Assets/Vector.png" alt="Cart Icon" className='vector'  />
