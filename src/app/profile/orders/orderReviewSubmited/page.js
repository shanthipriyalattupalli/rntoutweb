...
const orderData = [
  ...
  },
  {
    ...
    review: {
      ...
      feedback:
        "You can blindly trust Dell products but make sure you are buying them from a LEGIT seller.",
      images: [HistoryImage, HistoryImage, HistoryImage],
    },
  },
];
    ...
    <div className='order-detail'>
      <h2 className='item-header' onClick={() => router.back()}>
        <div className='back-product'>
          <IoMdArrowRoundBack style={{ marginRight: "12px" }} /> Order detail
        </div>
      </h2>
          ...
          <div className='order_trackinf_section'>
            ...
            <div className='shipping_address_sec'>
              ...
              <div className='address_detail'>
                ...
                <p>
                  Mohil Prajapati - <span>+91 12345 67890</span>
                </p>
                <p>
                  225, Sky Zone Business Hub Nr Shyamdham Mandir, Sarthana
                  Jakatnaka, Surat, Gujarat 395006
                </p>
              </div>
            </div>
              ...
              <div class='payment-details'>
                ...
                <p>
                  <a
                    href='#'
                    onClick={() => {
                      router.push("/profile/orders/SellerReview");
                    }}
                  >
