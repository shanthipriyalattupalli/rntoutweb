  ...
  return (
    ...
    <div className="dashboard">
      ...
      <header className="dashboard-header">
        <div className="logo">
          <img src={vector} alt="Logo"/>rntout
        </div>
  ...
  {item.status}
            ...
            <div className="action-menu">
                ...
                <div className="dropdown-menu">
                  <p><LuPencil />Edit</p>
                  <p><FaEye />View</p>
                  <p><MdToggleOff />Inactive?</p>
                  <p style={{color:'red'}}><RiDeleteBinLine />Delete</p>
                </div>
              </div>
            <img src='/Assets/dummy-image.svg' alt={item.title} className="item-image" />
            ...
            <div className="item-actions">
              <button className="view-insight" onClick={() => {router.push('/profile/products/productdetails')}}>View Rent Insight</button>
