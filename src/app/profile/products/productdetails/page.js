  ...
  return (
    <>
      <h2 className='item-header' onClick={() => router.back()}>
        <div className='back-product'><IoMdArrowRoundBack style={{ marginRight: "12px" }} />  Products
        </div></h2>
      <div className="rent-dashboard">
        ...
        <div className="product-info">
          ...
          <div className="product-details">
            <h2>Dell 24 inch P2425H Monitor | 100Hz | 5ms G-to-G (Fast Mode) | 99% sRGB</h2>
            <p>Available Stock: 5/8</p>
            <p>Rating & Reviews: ⭐ 4.5 (154 Reviews)</p>
            <a className="view-details-link" onClick={() => {router.push('/profile/products/details')}}>View all product details</a>
          </div>
        </div>
        ...
        <div className='dashboard-top'>
          ...
          <div className='price-section'>
            ...
            <div className='total-price'>₹1,59,237
            </div>
          </div>
        </div>
              ...
              {rents.map((rent) => (
                <div className="rent-item" key={rent.id}>
                  <div className="rent-header">
                    ...
                    <span className="rent-status">{rent.amount} {rent.status}</span>
                  </div>
            ...
            <div className="rating-reviews">
              <div>
                  ...
                  <div className="earning-and-ratings">
                    ...
                    <div className="rating-summary">
                      <div className="average-rating">
                        ...
                        <div className="stars"><img src={star2} width="128px" height="24px" alt="" /></div>
                      ...
                      <div className="detailed-ratings">
                        <div className="rating-bar">
                          ...
                          <div className="progress-bar1">
                            <div className="progress1" style={{ width: '20%' }}></div>
                          </div>
                          <span className="rating-count">(94,532)</span>
                        </div>
                        <div className="rating-bar">
                          <img src={star4} width="88px" height="16px" alt="" />
                          <div className="progress-bar1"><div className="progress1" style={{ width: '20%' }}></div></div>
                ...
                <div className="app-container">
                  <p className='pro-p5 m-0'>Community Feedback On This Product</p>
                  <div className="feedback-list">
                    ...
                    <div className="feedback-item">
                      ...
                      <div className="feedback-content">
                        <p className="feedback-message m-0">
                          Thank you so much for answering all questions patiently. You are superb and thanks for communicating. Beautiful predictions and will recommend my friends.
                        </p>
                    ...
                    <div className="feedback-item">
                      ...
                      <div className="feedback-content">
                        <p className="feedback-message m-0">
                          Thank you so much ma'am for listening to my problems with patience and for providing me your valuable guidance. 🙏🌼
                        </p>
                    ...
                    <div className="feedback-item">
                      ...
                      <div className="feedback-content">
                        <p className="feedback-message m-0">Awesome 💯 percent</p>
                      </div>
                    </div>
                    <div className="feedback-author">
                      <img src={rouimg} width="24px" height="24px" alt="" />
                    ...
                    <div className="feedback-item">
                      ...
                      <div className="feedback-content">
                        <p className="feedback-message m-0">
                          Very accurate reading. It was very relaxing talking to you.
                        </p>
