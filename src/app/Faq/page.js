                ...
                {categories.map((category, index) => (
                    ...
                    >
                        <div className="flex items-center space-x-3 mb-4">
                            <div className="bg-gray-100 p-3 rounded-full text-2xl">{category.icon}</div>
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm text-gray-500 mb-2">No. of questions: {category.questions}</p>
                            </div>
                        </div>
                        {/* <p className="text-sm text-gray-500 mb-2">No. of questions: {category.questions}</p> */}
                        <h3 className="text-sm font-semibold text-gray-700">TRENDING QUESTION</h3>
                        <ul className="list-disc  text-sm text-blue-500">
                            {category.trendingQuestions.map((question, idx) => (
                                <li
                                    key={idx}
